...
/**
 * Cross-document attribute highlighting.
 *
 ...
 * or a sub-document this file includes. That cross-document knowledge comes from
 ...
 * resolution: an attribute defined only in a descendant is "known" and so highlighted, even
 ...
 * index rebuilds — without a document edit — via {@link refreshCrossDocumentAttributesEffect}.
 */
 ...
 *   project-wide `attributes` view) — broader than the position-resolved value scope.
 ...
 * `getKnownNames` supplies the project-wide known-attribute names (lowercase) from
 ...
 * rebuilds, without a document edit.
 *
