...
- Name: registration-invitation.spec.ts >> Registration via invitation (US1) >> duplicate email rejection on invite
- Location: e2e/registration-invitation.spec.ts:93:7
