...
- Name: email-verification-gate.spec.ts >> Email verification gate (Bug #1) >> unverified user can still call /auth/resend-verification (exempt route)
- Location: e2e/email-verification-gate.spec.ts:71:7
