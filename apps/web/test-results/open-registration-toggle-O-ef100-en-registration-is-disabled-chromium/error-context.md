...
- Name: open-registration-toggle.spec.ts >> Open registration toggle (US4) >> direct navigation to /register is blocked when registration is disabled
- Location: e2e/open-registration-toggle.spec.ts:79:7
