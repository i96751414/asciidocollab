...
- Name: self-registration.spec.ts >> Self-registration with email verification (US2) >> open registration flow: register → check email → verify → dashboard
- Location: e2e/self-registration.spec.ts:18:7
