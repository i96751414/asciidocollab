...
- Name: open-registration-toggle.spec.ts >> Open registration toggle (US4) >> login page hides "Create an account" when open registration is disabled
- Location: e2e/open-registration-toggle.spec.ts:70:7
