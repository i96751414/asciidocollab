...
- Name: self-registration.spec.ts >> Self-registration with email verification (US2) >> resend verification email works
- Location: e2e/self-registration.spec.ts:82:7
