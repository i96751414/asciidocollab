...
- Name: user-management.spec.ts >> Admin user management (US3) >> sole-owner project is transferred (deleted) on user removal
- Location: e2e/user-management.spec.ts:107:7

# Error details

```
Error: invite failed: 403 {"error":{"code":"PERMISSION_DENIED","message":"Administrator access required"}}
```
