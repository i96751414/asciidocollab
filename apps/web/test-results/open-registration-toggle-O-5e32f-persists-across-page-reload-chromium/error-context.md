...
- Name: open-registration-toggle.spec.ts >> Open registration toggle (US4) >> open registration setting persists across page reload
- Location: e2e/open-registration-toggle.spec.ts:89:7
