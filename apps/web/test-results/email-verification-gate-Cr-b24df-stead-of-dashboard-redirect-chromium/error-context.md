...
- Name: email-verification-gate.spec.ts >> Cross-device verify-email UX (Bug #3+5) >> verify-email without a session shows log-in prompt instead of dashboard redirect
- Location: e2e/email-verification-gate.spec.ts:104:7
