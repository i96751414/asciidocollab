...
- Name: open-registration-toggle.spec.ts >> Open registration toggle (US4) >> login page shows "Create an account" when open registration is enabled
- Location: e2e/open-registration-toggle.spec.ts:60:7
