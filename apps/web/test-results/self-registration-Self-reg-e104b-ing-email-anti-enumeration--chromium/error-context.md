...
- Name: self-registration.spec.ts >> Self-registration with email verification (US2) >> registration returns 202 for existing email (anti-enumeration)
- Location: e2e/self-registration.spec.ts:120:7
