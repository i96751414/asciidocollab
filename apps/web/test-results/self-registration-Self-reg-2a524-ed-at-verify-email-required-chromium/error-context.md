...
- Name: self-registration.spec.ts >> Self-registration with email verification (US2) >> unverified user is gated at /verify-email-required
- Location: e2e/self-registration.spec.ts:54:7
