...
- Name: email-verification-gate.spec.ts >> Email verification gate (Bug #1) >> authenticated unverified user is blocked (403) from protected API endpoints
- Location: e2e/email-verification-gate.spec.ts:25:7
