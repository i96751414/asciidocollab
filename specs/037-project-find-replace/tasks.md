...
- [X] T029 Run `pnpm gate` (lint, typecheck, unit + integration + security scan + e2e across every touched package) and execute `/code-review` in a loop until zero findings (Constitution §End-of-Feature Verification). Run `quickstart.md` end-to-end.
